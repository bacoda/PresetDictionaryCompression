...
function _hbOnPrePV(req){
    ...
    _ar="foxsports.com_files/HG.gif";
    _lvl=-1; 
}
...
function _ER(a,b,c){if(_erf++==0)_hbi.src="foxsports.com_files/HG.gif"}
...
if(_D("ct")&&!_D("mlc"))_mlc=_ct;_XT("PrePVR","");_ar="foxsports.com_files/HG.gif";
...
+"",0,_pum))+_hbSendEV()+"&rf=";_ar+=(_IL(_ar)+_IL(_rf)<2048)?_A(_rf):"bookmark";_ar="foxsports.com_files/HG.gif";if(_IL(_ar)+_IL(_pl)<2048)_ar+="&pl="+_A(_pl);_ar="foxsports.com_files/HG.gif";
_XT("PrePV",_ar);if(_D("onlyMedia")!="y")_hbi.src=_ar;_hbq=_IS(_ar,0,_II(_ar,"&hec"));_XT("PostPV",_ar);_hbE=_NA()}_PV();
