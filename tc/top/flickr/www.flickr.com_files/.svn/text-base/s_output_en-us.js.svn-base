...
F.output.format_strs = {
	...
	mat_one_set_already_plural: '%s things were already in the set.',
	...
	group_photopickr_could_not_add_any: 'None of the things you\'ve selected can be added to the group, because they\'re either already in the group, in too many groups, or they don\'t follow the rules of this group.',
