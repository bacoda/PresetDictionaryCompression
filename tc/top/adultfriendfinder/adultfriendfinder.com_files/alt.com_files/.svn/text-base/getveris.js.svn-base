  ...
  // web server 
  seal_flash_url="alt.com_files/verisignseal.swf";
  seal_gif_url="alt.com_files/verisignseal.gif";

  if (location.href.indexOf('https') >= 0) {
    seal_flash_url = seal_flash_url.replace("http://graphics.","https://secure.");
    seal_gif_url = seal_gif_url.replace("http://graphics.","https://secure.");
  }
