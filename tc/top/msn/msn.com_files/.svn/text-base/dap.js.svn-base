var _daprr=new Array('msn.com_files/','msn.com_files/', 'msn.com_files/');var _daprs=0;if(location.hostname.toLowerCase().indexOf('.live.com')!=-1)
{_daprr=new Array('msn.com_files/','msn.com_files/', 'msn.com_files/');}
var _daplp='msn.com_files/';var acbMinWdth=160;var acbAdBarH=22;var acbDwnLdSt=false;var DPJS_BSC=0;var DPJS_ACB=1;var DPJS_4TH=2;var DPJS_ADV=4;function dap(qs,fw,fh,ob)
