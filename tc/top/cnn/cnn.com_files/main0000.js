...
function CNN_generateACommentDiv(clObject){
        ...
        CNN_comment += '                        <\/div>';
        CNN_comment += '                        <div class="clear"><img src="cnn.com_files/1.gif" width="1" height="1" border="0" alt=""></div><div class="cnnUGCBoxFooter"><img src="http://i.cdn.turner.com/cnn/.element/img/2.0/mosaic/base_skins/UGC/b_ugc_BL.gif" alt="" width="4" height="4"><\/div>';
        CNN_comment += '                <\/div>';
	return CNN_comment;
}
...
function cnnMpVpMoveDot() {
	for(i=1;i<4;i++) {
		$('cnnMpVidDot'+i).src = 'cnn.com_files/gray_status.gif';
		...
		$('cnnMpVidDot'+i).onmouseout = function() {this.src = 'cnn.com_files/gray_status.gif';}
	}
	$('cnnMpVidDot'+cnnMpVpCurPage).src = 'cnn.com_files/gray_active_status.gif';
...
function cnnMpVpUpdateBtns() {
	if(cnnMpVpCurPage > 1) {
		...
		$('cnnMpVidBtnL').src = 'cnn.com_files/left_red_btn.gif';
		$('cnnMpVidBtnL').onmouseover = function() { this.src='cnn.com_files/left_red_over_btn.gif'; }
		$('cnnMpVidBtnL').onmouseout = function() { this.src='cnn.com_files/left_red_btn.gif'; }
	}
	else {
		$('cnnMpVidBtnL').style.cursor ='default';
		$('cnnMpVidBtnL').src = 'cnn.com_files/left_gray_btn.gif';
	...
	if(cnnMpVpCurPage < 3) {
		...
		$('cnnMpVidBtnR').src = 'cnn.com_files/right_red_btn.gif';
		$('cnnMpVidBtnR').onmouseover = function() {this.src = 'cnn.com_/right_red_over_btn.gif';}
		$('cnnMpVidBtnR').onmouseout = function() {this.src = 'cnn.com_files/right_red_btn.gif';}
	}
	else {
		$('cnnMpVidBtnR').style.cursor ='default';
		$('cnnMpVidBtnR').src = 'cnn.com_files/right_gray_btn.gif';
...
var cnnDD = {
	...
	buildDisabledDropdown: function(menuId, buttonWidth, buttonClass, hiddenListSuffix) {
		...
		if ($(wrapId) && $(listId)) {
			...
			var leftBgStyle = 'background:#fff url(cnn.com_files/btn_ltg_left.gif) 0 0 no-repeat;';
			var rightBgStyle = 'background:url(cnn.com_files/btn_ltg_right.gif) 100% 0 no-repeat;';

			switch (buttonClass) {
				case 'cnnDDWire':
					leftBgStyle = 'background:#fff url(cnn.com_files/btn_wire_left.gif) 0 0 no-repeat;';
					rightBgStyle = 'background:url(cnn.com_files/btn_wire_right.gif) 100% 0 no-repeat;';
					break;
				case 'cnnBlkBgWhtBox':
					leftBgStyle = 'background:#fff url(cnn.com_files/btn_blk_left.gif) 0 0 no-repeat;';
					rightBgStyle = 'background:url(cnn.com_files/btn_blk_right.gif) 100% 0 no-repeat;';
					break;
			}
	...
	buildDropdown: function(menuId, buttonWidth, menuWidth, numVisibleRows, buttonClass, hiddenListSuffix) {
		...
		if ($(wrapId) && $(listId)) {
			...
			strContent += '						</td>'+"\n";
			strContent += '						<td width="'+buttonTextRPad+'"><img src="cnn.com_files/btn_icon.gif" alt="" border="0"></td>'+"\n";
			strContent += '					</tr>'+"\n";
			strContent += '				</table>'+"\n";
			strContent += '			</div><!--/cnnDDBtn -->'+"\n\n";
			strContent += '		</div><!--/'+buttonClass+' -->'+"\n\n";
	...
	buildOverlay: function(menuId, menuWidth, numVisibleRows, dx, dy) {
		...
		if ($(wrapId) && $(titleId) && $(listId)) {
			...
			strContent += '		<div class="clear"><img src="cnn.com_files/1.gif" width="1" height="1" border="0" alt=""></div>'+"\n";
...
/* career builder widget variables js
========================================================================= */
/* Opera removed to avoid oBench frame issues
var cnnDocDomain='';
