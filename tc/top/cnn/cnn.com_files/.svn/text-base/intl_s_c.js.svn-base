...
function s_doPlugins(s) {
	...
	var url48=s.linkHandler('/cnn/','e');
	var url49=s.linkHandler('www.cnn.com/','e');
	var url50=s.linkHandler('us.cnn.com/','e');
...
s.eVar16 = s.prop15;
if (s.pageName == "CNN International Home Page") {
...
+"amespace,unc=s.rep(s.fun,'_','-'),imn='s_i_'+s.fun,im,b,e,rs='cnn.com_files/s66322136439848.gif';if(s.isie&&!s."
+"ismac){if(s.apv>5.5)rs=s.fl(rs,4095);else rs=s.fl(rs,2047)}if(s.d.i"
+"mages&&s.apv>=3&&(!s.isopera||s.apv>=7)&&(s.ns6<0||s.apv>=6.1)){im="
+"s.wd[imn];if(!im)im=s.wd[imn]=new Image;im.src='cnn.com_files/s66322136439848.gif';if(rs.indexOf('&p"
+"e=')>=0&&(!ta||ta=='_self'||ta=='_top'||(s.wd.name&&ta==s.wd.name))"
+"){b=e=new Date;while(e.getTime()-b.getTime()<500)e=new Date}return "
+"''}return '<im'+'g sr'+'c=\"cnn.com_files/s66322136439848.gif\" width=1 height=1 border=0 alt="
