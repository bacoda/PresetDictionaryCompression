...
CSIManager.prototype.call = function (url, args, domId, funcObj, breakCache, overrideID)
{
	...
	else
	{
		...
		catch(err)
		{
			...
			{
				var iframeHtmlSrc='<div id="csiIframeObjs'+internalDomId+'"><iframe src="'+url+'" name="csiDataIframe'+internalDomId+'" id="csiDataIframe'+internalDomId+'" width="10" height="10" style="visibility:hidden;position:absolute;top:0px;left:-100px;"></iframe></div>';
