...
document.write('<DIV id="arrowright" class="hbBDRightArrowimgClass" onMouseDown="siMouseDown(\'HideMyProducts\')"><a href="#"><IMG src="weather.com_files/blank.gif" alt="" name="hbBDRightArrowimg" id="hbBDRightArrowimg" border="0" align="top"></a>');
document.write('</DIV>');
...
document.write('<DIV id="arrowright" class="hbBDRightArrowimgClass" onMouseDown="siMouseDown(\'ShowMyProducts\')"><a href="#"><IMG src="weather.com_files/blank.gif" alt="" name="hbBDLeftArrowimg" id="hbBDLeftArrowimg" border="0" align="top"></a>');
document.write('</DIV>');
...
document.write('<INPUT type="Password" name="password" width="25" height="10" class="inputwidth">&nbsp;&nbsp;<div class="buttonPad"><INPUT TYPE="image" src="weather.com_files/sign_in_button.gif" align="absmiddle"></div>');
document.write('</DIV>');
document.write('</FORM>');
...
document.write('<DIV id="hbhelpexit" class="hbTextSI"><A HREF="" onClick="return mapWindowOpen(\'/common/help/urssignin.html?from=hat_signin&refer=hat_signin\',\'Help\',\'width=466,height=450,resizable,scrollbars,nostatus\')"><IMG src="weather.com_files/sm_quest_box.gif" align="absmiddle"></A><IMG src="weather.com_files/blank.gif" width="2" height="2" alt="" border="0"><A href="#" onMouseDown="siMouseDown(\'snClosePanell\')"><IMG src="weather.com_files/sm_close_box.gif" align="absmiddle"></A></DIV>');
document.write('</DIV>');
