...
document.write('<DIV class="recentSearches" id="recentSearches">Recent Searches<SPAN style="padding: 0px 0px 0px 15px;"><IMG src="http://i.imwx.com/web/common/icons/sm_close_box.gif" border="0" onMouseDown="MyLocationClose(\'whatwhere\')"></SPAN></DIV>');
...
//This user has My City and My Watchlist....
	...
	//Begin mycity information
	document.write('<DIV class="myFavorites">My Favorites<SPAN style="padding: 0px 0px 0px 43px;"><IMG src="http://i.imwx.com/web/common/icons/sm_close_box.gif" border="0" onMouseDown="MyLocationClose(\'whatwhere\')"></SPAN></DIV>');
	document.write('<TABLE border="0" cellpadding="0" cellspacing="0"><TR><TD>');
	document.write('<a href ="http://www.weather.com/weather/local/'+splitCityInfo[0]+'?from=recentsearch" class="linkVerdanaText10">');
	var presentationName = splitCityInfo[2].replace("--",",");
