...
/************************ ADDITIONAL FEATURES ************************
	 ...
	 Last Modified By:    JME
	 Last Modified Date:  07/09/2008
*/

var s_account="twciwx"
...
s.eVar20=s.getTimeParting('h','-5','2008') + ":" + s.getTimeParting('d','-5','2008'); // Set Hour : Day
...
if(!s.eVar39)
        s.eVar39=s.getQueryParam('par')
        s.prop39=s.eVar39
		
if(!s.eVar40)
        s.eVar40=s.getQueryParam('site')
        s.prop40=s.eVar40
