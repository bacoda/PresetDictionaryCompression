document.write('<!-- Template Id = 1 Template Name = Banner Creative (Flash) -->\n<!-- Copyright 2002 DoubleClick Inc., All rights reserved. --><script src=\"doubleclick_files/flashwrite_1_2.js\"><\/script>');document.write('\n');
 
var dcswf = "doubleclick_files/no_rfss-180x70.swf"; 
var dcgif = "doubleclick_files/no_rfss-180x70.gif"; 
var advurl = "";
