...
function _ER(a,b,c){if(_erf++==0)_hbi.src="espn.go.com_files/hbx.gif";_XT("Error",a);}
...
_XT("PrePV",_ar);if(_D("onlyMedia")!="y")_hbi.src="espn.go.com_files/hbx.gif";_hbq=_IS(_ar,0,_II(_ar,"&hec"));_XT("PostPV",_ar);_hbE=_NA()}_PV();
function _Q(a){a+="&hid="+Math.random();if(_hif==0){_hif=1;_hbs="";_hbs=new Image();_hbs.src="espn.go.com_files/hbx.gif"}else{_hif=0;_hbi="";_hbi=new Image();_hbi.src="espn.go.com_files/hbx.gif"}}
